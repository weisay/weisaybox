...
<div id="map">
<div class="site">当前位置： <a title="返回首页" href="<?php echo esc_url( home_url('/') ); ?>">首页</a> &gt; 搜索 &gt; <?php echo wp_trim_words(get_search_query(), 28, '...' ); ?></div>
</div>
<?php if (have_posts()) : ?>
...
<h3  class="subtitle">非常抱歉，无法搜索到与之相匹配的信息。</h3>
</div>
</li></ul>
	<?php endif; ?>
