...
class WeisayBox_Theme_Updater {

	private $theme_slug;
	private $remote_url = 'https://img.weisay.com/theme/weisaybox/theme.json';
	private $theme_name = 'Weisay Box';
	private $author_name = 'Weisay';
	private $author_url = 'https://www.weisay.com';
	private $homepage_url = 'https://www.weisay.com/blog/wordpress-theme-weisay-box.html';
	private $cache_key = 'weisaybox_theme_update_info';
